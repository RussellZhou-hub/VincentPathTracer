...
//const std::string MODEL_PATH = "models/bathroom-blender.obj";
...
struct Vertex {
    glm::vec3 pos; int padA;
    glm::vec3 color; int padB;
    glm::vec3 normal; int padC;
...
//private:
    ...
    void createTextureImage(); //******************Textures***********************************
    ...
    void setShaderFileName(std::string vertPath, std::string fragPath);
    void loadModel();
...
#define VK_CHECK(x,y)                                                 \
	...
	{                                                               \
		...
		if (err)                                                    \
		{                                                           \
			std::cout <<y<<"  Detected Vulkan error: " << err << std::endl; \
			abort();                                                \
		}                                                           \
	} while (0)