...
namespace vkinit {
	...
	VkApplicationInfo application_info(const char* pApplicationName,uint32_t  applicationVersion= VK_MAKE_VERSION(1, 2, 0),const char* pEngineName="no engine",uint32_t engineVersion= VK_MAKE_VERSION(1, 0, 0),uint32_t  apiVersion= VK_API_VERSION_1_2);
	...
	VkPhysicalDeviceBufferDeviceAddressFeaturesEXT bufferDeviceAddress_features(VkBool32 bufferDeviceAddress=VK_TRUE,VkBool32 bufferDeviceAddressCaptureReplay= VK_FALSE,VkBool32 bufferDeviceAddressMultiDevice= VK_FALSE, void* pNext = nullptr);
	VkPhysicalDeviceRayQueryFeaturesKHR rayQuery_features(void* pNext=nullptr,VkBool32 rayQuery=VK_TRUE);
	VkPhysicalDeviceAccelerationStructureFeaturesKHR accelerationStructure_features(void* pNext, VkBool32 accelerationStructureHostCommands = VK_FALSE, VkBool32 accelerationStructureCaptureReplay= VK_TRUE,
														VkBool32 accelerationStructureIndirectBuild= VK_FALSE,VkBool32 descriptorBindingAccelerationStructureUpdateAfterBind= VK_FALSE, VkBool32 accelerationStructure = VK_TRUE);
	VkBufferDeviceAddressInfo BufferDeviceAddress_info(VkBuffer buffer, const void* pNext = nullptr);
	VkAccelerationStructureGeometryDataKHR AS_Geometry_data(VkAccelerationStructureGeometryTrianglesDataKHR triangles);
	VkAccelerationStructureGeometryKHR AS_geometry(VkAccelerationStructureGeometryDataKHR geometryData,VkGeometryTypeKHR geometryType= VK_GEOMETRY_TYPE_TRIANGLES_KHR,VkGeometryFlagsKHR flags= VK_GEOMETRY_OPAQUE_BIT_KHR, const void* pNext = nullptr);
	VkAccelerationStructureBuildGeometryInfoKHR accelerationStructureBuildGeometry_info(VkAccelerationStructureTypeKHR type, VkBuildAccelerationStructureFlagsKHR flags, const VkAccelerationStructureGeometryKHR* pGeometries, VkBuildAccelerationStructureModeKHR mode = VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR,
									VkAccelerationStructureKHR srcAccelerationStructure = VK_NULL_HANDLE, VkAccelerationStructureKHR dstAccelerationStructure = VK_NULL_HANDLE,
									uint32_t geometryCount = 1,const VkAccelerationStructureGeometryKHR* const* ppGeometries = nullptr,VkDeviceOrHostAddressKHR scratchData = {}, const void* pNext = nullptr);
	VkAccelerationStructureBuildSizesInfoKHR accelerationStructureBuildSizes_info(VkDeviceSize accelerationStructureSize=0,VkDeviceSize updateScratchSize=0,VkDeviceSize buildScratchSize=0, const void* pNext = nullptr);
	VkAccelerationStructureCreateInfoKHR accelerationStructureCreate_info(VkAccelerationStructureCreateFlagsKHR createFlags,VkBuffer buffer,VkDeviceSize size,VkAccelerationStructureTypeKHR type,
													VkDeviceAddress deviceAddress=NULL, VkDeviceSize offset = 0, const void* pNext = nullptr);
	// *****************************************end********************************************************
	//******************************************Pipeline***************************************************
	...
	VkPipelineShaderStageCreateInfo ShaderStage_info(VkShaderStageFlagBits stage,VkShaderModule shaderModule,const char* pName="main", const void* pNext = nullptr);
