...
VkDescriptorPoolSize vkinit::des_pool_size(VkDescriptorType type, uint32_t descriptorCount)
{
...
VkPhysicalDeviceBufferDeviceAddressFeaturesEXT vkinit::bufferDeviceAddress_features(VkBool32 bufferDeviceAddress, VkBool32 bufferDeviceAddressCaptureReplay, VkBool32 bufferDeviceAddressMultiDevice, void* pNext)
{
...
VkPhysicalDeviceRayQueryFeaturesKHR vkinit::rayQuery_features(void* pNext, VkBool32 rayQuery)
{
...
VkPhysicalDeviceAccelerationStructureFeaturesKHR vkinit::accelerationStructure_features(void* pNext, VkBool32 accelerationStructureHostCommands, VkBool32 accelerationStructureCaptureReplay, VkBool32 accelerationStructureIndirectBuild, VkBool32 descriptorBindingAccelerationStructureUpdateAfterBind, VkBool32 accelerationStructure)
{
	...
	features.pNext = pNext;
	features.accelerationStructure = accelerationStructure;
	features.accelerationStructureCaptureReplay = accelerationStructureCaptureReplay;
	features.accelerationStructureIndirectBuild = accelerationStructureIndirectBuild;
	features.accelerationStructureHostCommands = accelerationStructureHostCommands;
	features.descriptorBindingAccelerationStructureUpdateAfterBind = VK_FALSE;
	return features;
}

VkBufferDeviceAddressInfo vkinit::BufferDeviceAddress_info(VkBuffer buffer, const void* pNext)
{
...
VkAccelerationStructureGeometryDataKHR vkinit::AS_Geometry_data(VkAccelerationStructureGeometryTrianglesDataKHR triangles)
{
...
VkAccelerationStructureGeometryKHR vkinit::AS_geometry(VkAccelerationStructureGeometryDataKHR geometryData, VkGeometryTypeKHR geometryType, VkGeometryFlagsKHR flags, const void* pNext)
{
	VkAccelerationStructureGeometryKHR geometry{};
	geometry.sType = VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR;
	geometry.pNext = pNext;
...
VkAccelerationStructureBuildGeometryInfoKHR vkinit::accelerationStructureBuildGeometry_info(VkAccelerationStructureTypeKHR type, VkBuildAccelerationStructureFlagsKHR flags, const VkAccelerationStructureGeometryKHR* pGeometries, VkBuildAccelerationStructureModeKHR mode, VkAccelerationStructureKHR srcAccelerationStructure, VkAccelerationStructureKHR dstAccelerationStructure, uint32_t geometryCount, const VkAccelerationStructureGeometryKHR* const* ppGeometries, VkDeviceOrHostAddressKHR scratchData, const void* pNext)
{
...
VkAccelerationStructureBuildSizesInfoKHR vkinit::accelerationStructureBuildSizes_info(VkDeviceSize accelerationStructureSize, VkDeviceSize updateScratchSize, VkDeviceSize buildScratchSize, const void* pNext)
{
	VkAccelerationStructureBuildSizesInfoKHR info{};
	info.sType = VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_SIZES_INFO_KHR;
	info.pNext = pNext;
	info.accelerationStructureSize = accelerationStructureSize;
	info.updateScratchSize = updateScratchSize;
	info.buildScratchSize = buildScratchSize;
	return info;
}

VkAccelerationStructureCreateInfoKHR vkinit::accelerationStructureCreate_info(VkAccelerationStructureCreateFlagsKHR createFlags, VkBuffer buffer, VkDeviceSize size, VkAccelerationStructureTypeKHR type, VkDeviceAddress deviceAddress, VkDeviceSize offset, const void* pNext)
{
...
VkPipelineShaderStageCreateInfo vkinit::ShaderStage_info(VkShaderStageFlagBits stage, VkShaderModule shaderModule, const char* pName, const void* pNext)
{
